...
func (resp *Response) ToMap() map[string]any {
	return util.Obj2Map(*resp)
}

type Errors []Error

func (errs *Errors) String() string {
	return util.Json(*errs)
}

func (errs *Errors) ToMap() map[string]any {
	errors := make(map[string]any)
	errors["errors"] = errs
	return util.Obj2Map(errors)
}
...
func (option *QueryOption) GetTotalPage(totalPage int64) int {
	return int(math.Ceil(float64(totalPage) / float64(option.Limit)))
}
...
func (req *FilterRequest) String() string {
	return util.Json(*req)
}

func (req *FilterRequest) ToMap() map[string]any {
	return util.Obj2Map(*req)
}
...
func (req *FilterRequest) ClearFilters() {
	req.Filters = nil
}
